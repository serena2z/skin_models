...
def labelme_directory_to_detectron_dataset(directory, class_labels):
    ...
    for filename in files:
        ...
        images.append({\
            #"id": int(image_number), #alternative if image_id in json file--> "image_id": data['imageID']
            "image_id": int(image_number), #alternative if image_id in json file--> "image_id": data['imageID']
